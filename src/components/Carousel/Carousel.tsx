...
const Carousel = ({ active, items, onClick }: Props) => {
  ...
  return (
    <div className="carousel mb-12 mx-auto">
            ...
            return (
              <div
                ...
                className={classNames(
                  "carousel-item text-center relative w-64 h-80 snap-start my-2",
              ...
              >
                ...
                <div
                  ...
                  className={classNames(
                    "h-full w-full aspect-square block absolute top-0 left-0 transition-opacity duration-300 opacity-100 bg-blue-800/75 z-10 rounded cursor-pointer"
                  )}
                >
